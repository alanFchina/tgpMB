...
#define	CMD_STRING_LENGTH		30000
...
typedef struct node
	...
	int		scalersSet[MAX_NUM_DIV_LONGS], clSpace[MAX_NUM_DIV_LONGS], tiSpace[MAX_NUM_DIV_LONGS];
	int 		*partition;
	char			label[100];
...
typedef int (MoveFxn)(Param *param, int chain, int *seed, MrBFlt *lnPriorRatio, MrBFlt *lnProposalRatio, MrBFlt *mvp);
...
typedef struct chain
	...
	int	chainSeed;             /* random seed for chain                         */
