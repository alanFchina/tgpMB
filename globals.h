...
extern unsigned int expecting;								/* variable denoting expected token type         */
...
extern int			globalSeed;                             /* seed that is initialized at start up          */
...
extern int				nBitsInALong;                			/* number of bits in a int			             */
...
extern int			runIDSeed;                              /* seed used only for generating run ID [stamp]  */
extern char				spacer[10];                             /* holds blanks for printing indentations        */
extern int			swapSeed;                               /* seed used only for determining which to swap  */
...
extern int				intIntegerSize;                        /* size of an integer                       */
